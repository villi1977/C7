...
%triggerin -- vzctl,vzctl-core,vzquota,ploop,ploop-lib,kernel,vzkernel,ovzkernel,pstorage-metadata-server,pstorage-chunk-server,pstorage-client
%{_sbindir}/vzstats &

%changelog
* Tue Feb 11 2014 Kir Kolyshkin <kir@openvz.org> - 0.5.3-1
- vzstats.conf should not be executable (#2758)
- Scripts shall start with hash-bang (#2757)
- added pstorage packages

* Tue Sep 24 2013 Kir Kolyshkin <kir@openvz.org> - 0.5.2-1
- removed top-ps script (#2704)
